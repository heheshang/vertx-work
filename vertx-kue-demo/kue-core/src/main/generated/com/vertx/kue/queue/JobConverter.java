...
/**
 * Converter for {@link com.vertx.kue.queue.Job}.
 * <p>
 * NOTE: This class has been automatically generated from the {@link com.vertx.kue.queue.Job} original class using Vert.x codegen.
 */
public class JobConverter {
    ...
    public static void fromJson(JsonObject json, Job obj) {
        ...
        if (json.getValue("priority") instanceof String) {
            obj.setPriority(com.vertx.kue.queue.Priority.valueOf((String) json.getValue("priority")));
        }
        ...
        if (json.getValue("state") instanceof String) {
            obj.setState(com.vertx.kue.queue.JobState.valueOf((String) json.getValue("state")));
        }
