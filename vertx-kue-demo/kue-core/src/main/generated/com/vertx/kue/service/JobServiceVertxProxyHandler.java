    ...
    public void handle(Message<JsonObject> msg) {
        ...
        try {
            ...
            switch (action) {
                ...
                case "cardByType": {
                    service.cardByType((java.lang.String) json.getValue("type"), json.getString("state") == null ? null : com.vertx.kue.queue.JobState.valueOf(json.getString("state")), createHandler(msg));
                    break;
                }
                case "card": {
                    service.card(json.getString("state") == null ? null : com.vertx.kue.queue.JobState.valueOf(json.getString("state")), createHandler(msg));
                    break;
                }
                case "completeCount": {
                ...
                case "getIdsByState": {
                    service.getIdsByState(json.getString("state") == null ? null : com.vertx.kue.queue.JobState.valueOf(json.getString("state")), createListHandler(msg));
                    break;
                }
                case "getWorkTime": {
